...
<form action="" method="post" id="profile-wp-edit-form" class="standard-form private-info">
	<h4>User fields</h4>
	<div class="clear"></div>
	<div class="field_type_textbox">	
		<label for="first_name">First name</label>
		<input id="first_name" name="first_name" type="text" value="<?php echo get_user_meta( $bp->displayed_user->id, 'first_name', true );?>">
	</div>
	<div class="field_type_textbox">	
		<label for="last_name">Last name</label>
		<input id="last_name" name="last_name" type="text" value="<?php echo get_user_meta( $bp->displayed_user->id, 'last_name', true );?>">
	</div>
