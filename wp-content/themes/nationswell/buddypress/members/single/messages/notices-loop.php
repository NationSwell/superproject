...
<?php if ( bp_has_message_threads() ) : ?>
	...
	<table id="message-threads" class="messages-notices sitewide-notices" cellpadding="20"  cellspacing="0">
		<?php while ( bp_message_threads() ) : bp_message_thread(); ?>
			<tr id="notice-<?php bp_message_notice_id(); ?>" class="<?php bp_message_css_class(); ?>">
				<td width="1%"></td>
				<td width="38%" style="padding:10px;">
					<strong><?php bp_message_notice_subject(); ?></strong>
					<?php bp_message_notice_text(); ?>
				</td>
				<td width="21%" style="padding:10px;">
				...
				<td width="10%" style="padding:10px;">
					<a href="<?php bp_message_activate_deactivate_link(); ?>" class="confirm"><?php bp_message_activate_deactivate_text(); ?></a><br>
					<a href="<?php bp_message_notice_delete_link(); ?>" class="confirm" title="<?php esc_attr_e( "Delete Message", 'buddypress' ); ?>"><?php esc_attr_e( "Delete", 'buddypress' ); ?></a>
				</td>
			</tr>
		<?php endwhile; ?>
