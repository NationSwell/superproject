...
<form action="<?php bp_activity_post_form_action(); ?>" method="post" id="whats-new-form" name="whats-new-form" role="complementary">
	...
	<div id="whats-new-content">
		<div id="whats-new-textarea" class="form-element">
			<label for="whats-new" class="bp-screen-reader-text"><?php _e( 'Post what’s new', 'buddypress' ); ?></label>
			<textarea class="bp-suggestions text-area" name="whats-new" id="whats-new" cols="50" rows="5"
		...
		<div id="whats-new-options">
			<div id="whats-new-submit">
				<input type="submit" name="aw-whats-new-submit" id="aw-whats-new-submit" class="btn" value="<?php esc_attr_e( 'Post update', 'buddypress' ); ?>" />
			</div>
